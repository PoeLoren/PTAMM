...
class Game
{
  public:
    ...
    virtual ~Game() {};
    virtual void Draw3D(const GLWindow2 &glWindow, Map &map, SE3<> se3CfromW, ATANCamera &mCamera) = 0;  /// draw the game for a map
	virtual void setStatusFlag(int id){}
	virtual void setFBOOBJECT(GLuint id){}
	virtual void setFBOGHOST(GLuint id){}
	virtual void setFBOMED(GLuint id){}
	virtual void setFBOEDGE(GLuint id){}
	virtual void setFBOMIRROR(GLuint id){}
